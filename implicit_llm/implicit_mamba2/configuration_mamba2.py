...
class ImplicitMambaConfig(PretrainedConfig):
    ...
    def __init__(
        ...
        load_from_pretrained_shell: bool = False,
...
if __name__ == "__main__":
    ...
    my_config = ImplicitMambaConfig.from_pretrained(pretrained_model_config_name)
